...
func (d *Device) ReadAcceleration() (x int16, y int16, z int16) {
    ...
    switch d.AccelRange {
        case ACCEL_RANGE_2G: range_factor = 1
        case ACCEL_RANGE_4G: range_factor = 2
        case ACCEL_RANGE_8G: range_factor = 4
        case ACCEL_RANGE_16G: range_factor = 12 // the readings in 16G are a bit off
    }
